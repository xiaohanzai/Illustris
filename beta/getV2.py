...
def main():
	...
	R_bin, z_bin, phi_bin, a11, a12, a13, a22, a23, a33, v1, v2, v3, nu, NperBin = \
	    measureV2map(V2data.xcyl, V2data.vcyl, V2data.mpart)
	beta = 1 - a33/a11
	np.save(path + 'V2tensor.npy', 
		   [R_bin, z_bin, phi_bin, a11, a12, a13, a22, a23, a33, beta, nu, NperBin])
