...
def plotShape_profile(R, axisRatios, axes=None, color='k'):
    axes.plot(R, axisRatios[:, 0], '-', lw=3, color=color)
    axes.plot(R, axisRatios[:, 1], '--', lw=3, color=color)


def plotShape_dot(R, axisRatios, axes=None, color='k', markersize=2.0):
...
def plotOrientation_profile(R, eigenVectors, axes=None, color='k'):
...
def plotOrientation_dot(R, eigenVectors, axes=None, color='k',
